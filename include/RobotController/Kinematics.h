...
public:
  ...
  /**
   * @brief Function for performing forward kinematics. Returns current position of the end-effector based on current
   * servo angles
   *
  ...
  /**
   * @brief Function for performing inverse kinematics. Returns new servo angles based on the angles the servos are
   * currently set to and the goal position
   *
   * @param angles The angles the servos are currently set to
...
private:
  ...
  /**
   * @brief Matrix containing the limits of the servos (min, max), in the order Base, Shoulder, Elbow, Wrist,
   * WristRotate
   *
   */
